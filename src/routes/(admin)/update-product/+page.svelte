...
<div class="min-h-screen dark:bg-black/10 dark:text-white/90">
    <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 relative
        ...
        {#if form?.data}
            ...
            <button on:click={() => form.data = undefined} class="px-4 py-2 bg-blue-500 text-white rounded absolute top-2 right-2">Search</button>
        {:else}
