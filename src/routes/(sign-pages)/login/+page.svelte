...
<div
	class="flex pb-[7rem] dark:bg-darkmode-500 dark:text-white/90 justify-center gap-[3rem] flex-col  items-center min-h-screen"
>
	<h1 class="sm:text-5xl text-3xl py-[5rem] mb-6 font-bold">Log In</h1>
	<form
