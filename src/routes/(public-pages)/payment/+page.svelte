...
<div class="min-h-screen w-full relative flex flex-col dark:bg-black/10 dark:text-white/90">
    ...
    {#if form?.failed}
        <div id="alert-border-2" class="flex items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 
        bg-red-50 dark:text-red-400 dark:bg-gray-800 absolute bottom-23 right-10 dark:border-red-800" role="alert">
