...
<ol class="flex pt-[3rem] justify-center mx-auto p-4 max-w-7xl items-center w-full mb-4 sm:mb-5">
	...
	<li>
		<div
			class="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full lg:h-12 lg:w-12
